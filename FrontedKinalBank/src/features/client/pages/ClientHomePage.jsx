    ...
    return (
        ...
        >
            ...
            <p className="text-2xl font-bold text-gray-900 mb-1">
                ...
                {Number(account.balance).toLocaleString("es-GT", {
    ...
    return (
        <div className="flex items-center gap-3 py-3 border-b border-gray-50 last:border-0">
            ...
            >
                {isCredit ? "+" : "-"}
                {symbol}
                {safeAmount.toLocaleString("es-GT", {
                    minimumFractionDigits: 2
                })}
            </p>
            ...
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-2 px-5 py-3 rounded-2xl bg-white border border-gray-200 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:border-indigo-200 hover:text-indigo-600 shadow-sm transition-all whitespace-nowrap"
                    >
                        ✏️ Editar perfil
                    </button>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <StatCard
                        label="Total en USD"
                        value={`$ ${totalUSD.toLocaleString("es-GT", {
                            minimumFractionDigits: 2
                        })}`}
                        icon="🇺🇸"
                        color="blue"
